...
const {id, first_name, last_name, email, phone, company_id} = props.employee.data
const form = useForm({first_name, last_name, email, phone, company_id});
const companies = props.companies.data
const submit = () => {
    form.put(route('employees.update', id));
};
                        ...
                        <form name="createForm" @submit.prevent="submit">
                                <div className="flex flex-col">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <span className="text-red-600" v-if="form.errors.logo">
                                            {{ form.errors.logo }}
                                        </span>
                                    </div>
                                </div>
